...
const translations = {
  en: {
    ...
    nav_home: "Home",
    nav_catalog: "Vault Catalog",
    nav_jewelry: "Custom Jewelry",
    nav_sell: "Sell / Trade NY",
    nav_process: "Process",
    nav_guarantee: "Guarantee",
    nav_reviews: "NYC Reviews",
    nav_faq: "FAQ",
    btn_quote: "Quote Watch",
    hero_badge: "New York's Premier Luxury Watch Dealer • 20+ Yrs",
    ...
    stat_years: "Years NY Leadership",
    ...
    badge_exp: "Years Leading NYC Market",
  ...
  es: {
    ...
    nav_home: "Inicio",
    nav_catalog: "Catálogo Bóveda",
    nav_jewelry: "Joyería Personalizada",
    nav_sell: "Vender / Cambiar NY",
    nav_process: "Proceso",
    nav_guarantee: "Garantía",
    nav_reviews: "Reseñas NYC",
    nav_faq: "FAQ",
    btn_quote: "Tasar Reloj",
    hero_badge: "Líder de Relojes de Lujo en New York • 20+ Años",
    hero_title: "Sell • Buy • Trade Authentic Luxury Timepieces",
    ...
    stat_years: "Años de Liderazgo en NY",
    ...
    ab_tag: "Por Qué Elegir Rod Watches NYC",
    ...
    badge_exp: "Años Liderando el Mercado de NY",
